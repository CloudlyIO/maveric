...
if __name__ == "__main__":
    """
    Test the train_es_rl and infer_es_rl functions.
    ...
    try:
        ...
        logger.info(f"Testing train_es_rl function with {test_timesteps} timesteps...")
        trained_model_path = train_es_rl(
            train_days=[0, 1, 2, 3],
            total_timesteps=test_timesteps
        )
        logger.info(f"Training completed. Model saved at: {trained_model_path}")
        ...
        logger.info("Testing infer_es_rl function...")
