...
try:
    ...
    from dependencies.apps.coverage_capacity_optimization.cco_engine import CcoEngine
    from dependencies.radp.digital_twin.rf.bayesian.bayesian_engine import BayesianDigitalTwin
    from dependencies.radp.digital_twin.utils import constants as c
    from dependencies.radp.digital_twin.utils.cell_selection import perform_attachment
